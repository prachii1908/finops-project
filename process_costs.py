...
<div class="main">
  ...
  <div class="panel active" id="panel-overview">
    ...
    <div class="g2">
      ...
      <div class="cb"><h3>Monthly cost trend</h3><div class="cb-sub">Total subscription cost across all loaded months</div><div style="position:relative;height:260px"><canvas id="c-trend"></canvas></div></div>
    </div>
  </div>
